...
//        g2.drawRect(0,yPos,this.getWidth()-1,this.getHeight()-yPos-1);
  ...
  public StickingPolygon getStickingBorder() { //LME
    ...
    p.addLine(new Point(0,0), new Point(maxUpperBox,0));
    p.addLine(new Point(maxUpperBox,yPos), new Point(getWidth()-1,yPos));
    p.addLine(new Point(maxUpperBox,0), new Point(maxUpperBox,yPos));
    p.addLine(new Point(getWidth()-1,yPos), new Point(getWidth()-1,getHeight()-1));
    p.addLine(new Point(getWidth()-1,getHeight()-1), new Point(0,getHeight()-1));
    p.addLine(new Point(0,getHeight()-1), new Point(0,0));
    return p;
  }
}