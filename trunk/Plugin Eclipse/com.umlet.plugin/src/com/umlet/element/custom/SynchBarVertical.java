...
public class SynchBarVertical extends Entity {
	...
	public void paintEntity(Graphics g) {
	    ...
	    if (yPos>this.getHeight()) {
	      (new Resize(this,4,0,this.handler.getFontsize()+this.handler.getDistTextToText())).execute(this.handler);
	      return;
	    }
...
/*	public int doesCoordinateAppearToBeConnectedToMe(Point p) {
	...
	public StickingPolygon getStickingBorder() {
	    ...
	    p.addLine(new Point(this.getWidth()/2-1,textHeight), new Point(this.getWidth()/2-1,this.getHeight()-1));
	    return p;
	  }
