...
public abstract class CustomElement extends Entity {
	...
	private String code;
	private StickingPolygon stickingpolygon;
	...
	@Override
	public final StickingPolygon getStickingBorder() {
		if(this.stickingpolygon == null)
			return super.getStickingBorder();
		return this.stickingpolygon;
	}
	...
	protected final void addStickingPoint(int x, int y/*, int resize_direction*/) 
	{
		Point p = new Point(x,y);
		if(this.stickingpolygon != null)
			this.stickingpolygon.addLine(this.laststickingpoint, p);
		else
			this.stickingpolygon = new StickingPolygon();
